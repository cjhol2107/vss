...
<div class="row">
	<div class="col-lg-12">
		<div class="page-header title">Share Tips & Tech
			<div class="subtitle"> 각종 팁이나 정보를 공유하는 곳입니다.</div>
			<div class="subtitle2"> 누군가에게 도움이 된다 싶으면 언제나 포스팅 :)</div>
		</div>
	</div>
</div>
...
<div class="row">
	<div class="col-xs-12">   
		<table class="table table-hover table-boardlist">
		  <thead>
		...
		<div class='row'>
			<div class="col-lg-12">
				<div class="col-xs-6 text-left search">
					<form id='searchForm' action="/knwShrBoard/list" method='get'>
		...
		<form id='actionForm' action="/knwShrBoard/list" method='get'>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#regBtn").on("click", function() {
			self.location = "/knwShrBoard/register";
		});
		...
		$(".move").on("click",function(e) {
			...
			actionForm.attr("action","/knwShrBoard/get");
			actionForm.submit();
		});
		...
		$(".btn-xs").on("click", function(e) {
			...
			var href = ""; 
			href += "/knwShrBoard/list.do?libCls="+libCls;
